...
| PM24 | Grove, the second cave (wasp nest), fresh | Enter; the hover at the mouth; go to the deep west chamber | The cave loads; *"The floor of the cave is paper..."*; a cursed wasp three times the size, named Wasp Queen, 220 HP; two stingers on death |
