# Lionheart Fixt 0.5.1 - the thieves' guild
...
Of the three things in this release, **one has been played to the end.** The vault
was walked as far as its entrance -- which is how two fatal crashes were found, both of
them art I referenced without checking it existed. 0.5.0 was packaged with both and
never published. The caught-in-the-act branch is still unplayed, and the notes say so.
