...
-- currently [0.10.2](https://github.com/EricHype/LionheartFixt/releases/tag/v0.10.2).
...
**0.1.0 through 0.10.2 are published.** The current playthrough is walking 0.10.0 as it goes; what
