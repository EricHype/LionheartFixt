...
-- currently [0.14.0](https://github.com/EricHype/LionheartFixt/releases/tag/v0.14.0).
...
**0.1.0 through 0.14.0 are published.** The last three -- 0.14.0 Montaillou, 0.13.0 The Road North
and 0.12.0 La Calle Perdida -- are built and entirely unplayed, as are 0.11.0's Sahar, ring and rout. What the playthrough finds is repaired on `main` and cut as
